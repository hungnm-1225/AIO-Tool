...
export const MAIN_MENU_ITEMS: MainMenuItem[] = [
  ...
  },
  {
    ...
    submenus: [
      ...
      {
        subSlug: "merge-table",
        labelVi: "Gộp Bảng Dữ Liệu",
        labelEn: "Merge Table",
        descriptionVi: "Gộp bảng dọc theo thư mục hoặc ghép cột ngang theo khóa chung",
        descriptionEn: "Stack tables vertically or join columns by a common key",
        icon: FolderOpen,
...
const LEGACY_HASH_MAP: Record<string, { mainSlug: string; subSlug: string }> = {
  ...
  "gop-thu-muc-xlsx-csv": { mainSlug: "excel-suite", subSlug: "merge-table" },
